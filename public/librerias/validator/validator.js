...
var validator = (function($){
    ...
    */
    message = {
        invalid         : 'dato erroneo',
        checked         : 'debe estar seleccionado',
        empty           : 'No deje en blanco',
        min             : 'texto demasido corto',
        max             : 'texto demasido largo',
        number_min      : 'muy corto',
        number_max      : 'muy grande',
        url             : 'URL invalida',
        number          : 'no es un numero',
        email           : 'el correo no es valido',
        email_repeat    : 'correo diferente',
        password_repeat : 'contraseñas diferentes',
        repeat          : 'no es igual',
